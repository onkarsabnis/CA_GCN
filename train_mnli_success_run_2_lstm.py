...
def main():
    ...
    hyps["train_len"] = 4969
    hyps["warmup_steps"] = int((4969 / hyps["batch_size"]) / 10)
    hyps["dropout_inter"] = 0
    hyps["input_data_list"] = ['../dependency_scientsbank_train_new.tsv', '../dependency_scientsbank_test_UA.tsv','../dependency_scientsbank_test_UQ.tsv']
    hyps["input_label_list"] = ['../scientsbank_train_new_labels.txt', '../scientsbank_test_UA_labels.txt','../scientsbank_test_UQ_labels.txt']
    ...
    t_total = int(4969 / hyps["batch_size"]) * hyps["epochs"]
