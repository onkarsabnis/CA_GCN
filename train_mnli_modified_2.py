...
def main():
    ...
    hyps["train_len"] = 2500     ##392702
    hyps["warmup_steps"] = int((360000 / hyps["batch_size"]) / 10)
    hyps["dropout_inter"] = 0
    hyps["input_data_list"] = ['data/MNLI/dependency_mnli_dev_matched.tsv']          ### 'data/MNLI/dependency_mnli_train.tsv', 'data/MNLI/dependency_mnli_dev_mismatched.tsv']
    hyps["input_label_list"] = ['data/MNLI/dev_matched_labels.txt']                 ### 'data/MNLI/train_labels.txt', 'data/MNLI/dev_mismatched_labels.txt']
    ...
    print("Hyps[train_len] " , hyps["train_len"])
    print("Len list ", len_list[0])
