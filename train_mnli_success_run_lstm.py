...
def main():
    ...
    hyps["encoder_type"] = "lstm" # "lstm", "bert" or "roberta"
    ...
    hyps["input_data_list"] = ['../dependency_scientsbank_train_matched.tsv', '../dependency_scientsbank_train_matched.tsv','../dependency_scientsbank_train_matched.tsv']
    hyps["input_label_list"] = ['../scientsbank_train_labels.txt', '../scientsbank_train_labels.txt','../scientsbank_train_labels.txt']
    ...
    for epoch in tqdm(range(hyps["epochs"]), desc="Training Epochs"):
        ...
        for iter, data_batch in enumerate(traindata_loader):
            ...
            if iter % 100 == 0:
                ...
                print('Epoch {}, iter {}, loss {:.4f}, lr {:.3e}'.format(epoch, iter, loss.detach().item(),   
                        network.optimizer_other.state_dict()['param_groups'][0]['lr']))   ### network.optimizer_bert.state_dict()['param_groups'][0]['lr'],
